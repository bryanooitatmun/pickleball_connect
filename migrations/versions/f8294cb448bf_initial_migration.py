...
Revision ID: f8294cb448bf
Revises: 
Create Date: 2025-03-13 00:46:53.040303
...
def upgrade():
    ...
    op.create_table('academy_coach_role',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('booking_link', sa.String(length=256), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('tag',
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('is_academy_manager', sa.Boolean(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('academy_pricing_plan',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('academy_id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=128), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    ...
    op.create_table('academy_tag',
    sa.Column('academy_id', sa.Integer(), nullable=False),
    sa.Column('tag_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['academy_id'], ['academy.id'], ),
    sa.ForeignKeyConstraint(['tag_id'], ['tag.id'], ),
    sa.PrimaryKeyConstraint('academy_id', 'tag_id')
    )
    ...
    sa.ForeignKeyConstraint(['role_id'], ['academy_coach_role.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('student_books_court', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['coach_id'], ['coach.id'], ),
    sa.ForeignKeyConstraint(['court_id'], ['court.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('status', sa.String(length=20), nullable=True),
    sa.Column('venue_confirmed', sa.Boolean(), nullable=True),
    sa.Column('coaching_payment_required', sa.Boolean(), nullable=True),
    sa.Column('coaching_payment_status', sa.String(length=20), nullable=True),
    sa.Column('court_payment_required', sa.Boolean(), nullable=True),
    sa.Column('court_payment_status', sa.String(length=20), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('pricing_plan_id', sa.Integer(), nullable=True),
    sa.Column('academy_pricing_plan_id', sa.Integer(), nullable=True),
    ...
    sa.CheckConstraint('(coach_id IS NOT NULL AND academy_id IS NULL) OR (coach_id IS NULL AND academy_id IS NOT NULL)', name='check_coach_or_academy'),
    sa.CheckConstraint('(pricing_plan_id IS NOT NULL AND academy_pricing_plan_id IS NULL) OR (pricing_plan_id IS NULL AND academy_pricing_plan_id IS NOT NULL)', name='check_pricing_plan_type'),
    sa.ForeignKeyConstraint(['academy_id'], ['academy.id'], ),
    sa.ForeignKeyConstraint(['academy_pricing_plan_id'], ['academy_pricing_plan.id'], ),
    sa.ForeignKeyConstraint(['coach_id'], ['coach.id'], ),
    sa.ForeignKeyConstraint(['pricing_plan_id'], ['pricing_plan.id'], ),
    sa.ForeignKeyConstraint(['student_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
...
def downgrade():
    ...
    op.drop_table('coach')
    op.drop_table('academy_tag')
    op.drop_table('academy_pricing_plan')
    ...
    op.drop_table('academy_coach_role')
